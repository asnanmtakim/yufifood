   ...
   <section class="section">
      <div class="section-header">
         ...
         <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item">Edit Penjualan</div>
         </div>
      </div>
            ...
            <div class="col-12">
               <div class="card card-success">
                  <div class="card-body">
                     ...
                     <hr>
                     <form id="form-jual">
                        <input type="hidden" name="jual_id" value="<?= $jual['jual_id']; ?>">
                        <div class="row">
                           <div class="col-12 col-sm-5 col-md-4">
                              <div class="form-group">
                                 <label>Tanggal Jual</label>
                                 <input type="text" name="jual_tgl" id="jual_tgl" class="form-control datepicker" placeholder="Tangal Jual" value="<?= date("d-m-Y", strtotime($jual['jual_tgl'])); ?>">
                              </div>
                           </div>
                           <div class="col-12 col-sm-7 col-md-8">
                              <div class="form-group">
                                 <label>Deskripsi</label>
                                 <input type="text" name="jual_desc" id="jual_desc" class="form-control" placeholder="Deskripsi Penjualan" value="<?= $jual['jual_desc']; ?>">
                              </div>
                           </div>
                        </div>
                        <div class="row">
