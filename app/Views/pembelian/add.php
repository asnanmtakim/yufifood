            ...
            <div class="col-12">
               <div class="card card-success">
                  <div class="card-body">
                     ...
                     <hr>
                     <form id="form-beli">
                        <input type="hidden" name="beli_id">
                        <div class="row">
                           <div class="col-12 col-sm-5 col-md-4">
                              <div class="form-group">
                                 <label>Tanggal Beli</label>
                                 <input type="text" name="beli_tgl" id="beli_tgl" class="form-control datepicker" placeholder="Tangal Beli">
                              </div>
                           </div>
                           <div class="col-12 col-sm-7 col-md-8">
                              <div class="form-group">
                                 <label>Deskripsi</label>
                                 <input type="text" name="beli_desc" id="beli_desc" class="form-control" placeholder="Deskripsi Pembelian">
                              </div>
                           </div>
                        </div>
                        <div class="row">
...
<script>
   ...
   $(document).off("click", "table#tb-beli button#reset-beli")
      .on("click", "table#tb-beli button#reset-beli", function(e) {
         e.preventDefault();
         swal({
            title: "Reset Semua Data Pembelian ?",
            text: "Reset",
            icon: "warning",
            buttons: true,
            dangerMode: true,
