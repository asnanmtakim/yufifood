...
<script>
   ...
   $(document).off("click", ".dropdown-menu .dropdown-item")
      .on("click", ".dropdown-menu .dropdown-item", function(e) {
         ...
         $.ajax({
            type: "POST",
            url: BASE_URL + "/laporan_penjualan/setSession",
            data: {
               name: 'sort',
               value: sort
            },
   ...
   function buildLineChart() {
      $.ajax({
         ...
         dataType: "json",
         success: function(res) {
            var penjualan_chart = document.getElementById("myChart").getContext('2d');
            myChart = new Chart(penjualan_chart, {
               type: 'line',
               data: {
   ...
   function buildPieChart() {
      $.ajax({
         type: "GET",
         url: BASE_URL + "/laporan_penjualan/getDetailPenjualan",
         dataType: "json",
         success: function(res) {
            var randomColor = [];
