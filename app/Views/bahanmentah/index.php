   ...
   <section class="section">
      <div class="section-header">
         ...
         <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item active">Bahan Mentah</div>
         </div>
      </div>
      ...
      <div class="modal-content">
         ...
         <div class="modal-body pb-0">
            <form id="form-data" class="form form-horizontal">
               <div class="form-body">
                  <input type="hidden" name="mentah_id" id="mentah_id">
                  <div class="form-row">
                     <div class="form-group col-md-12">
                        <label for="mentah_nama">Nama bahan mentah</label>
                        <input type="text" class="form-control" id="mentah_nama" name="mentah_nama" placeholder="Nama bahan mentah">
                     </div>
                  </div>
                  <div class="form-row">
                     <div class="form-group col-md-6">
                        <label for="mentah_satuan">Satuan bahan mentah</label>
                        <input type="text" class="form-control" id="mentah_satuan" name="mentah_satuan" placeholder="Satuan bahan mentah">
                     </div>
                     <div class="form-group col-md-6">
                        <label for="mentah_harga">Harga satuan (Rp)</label>
                        <input type="number" class="form-control" id="mentah_harga" name="mentah_harga" placeholder="Harga satuan (Rp)">
                     </div>
                  </div>
                  <div class="form-row">
                     <div class="form-group col-md-12">
                        <label for="mentah_desc">Deskripsi bahan mentah</label>
                        <textarea class="form-control" name="mentah_desc" id="mentah_desc" placeholder="Deskripsi bahan mentah"></textarea>
                     </div>
                  </div>
               </div>
            </form>
...
<script>
   ...
   function tableLoad() {
      ...
      $.ajax({
         type: "GET",
         url: BASE_URL + "/bahanmentah/readBahanmentah",
         success: function(data) {
            ...
            $.each(data, function(i, val) {
               ...
               t += '<td>' + val.mentah_satuan + '</td>';
               t += '<td>' + formatRupiah(val.mentah_harga) + '</td>';
               t += '<td>' + val.mentah_desc + '</td>';
               t += `<td class="text-center">
                        <div class="btn-group">
                           ...
                           <button class="btn btn-sm btn-danger item_hapus" title="Hapus" data-id="` + val.id + `" data-name="` + val.mentah_nama + `"><i class="fas fa-trash"></i></button>
                        </div>
                     </td>`;
               t += '</tr>';
   ...
   $(document).off("click", "table#tb-data button.item_edit")
      .on("click", "table#tb-data button.item_edit", function(e) {
         ...
         $.ajax({
            type: "POST",
            url: BASE_URL + "/bahanmentah/getOneBahanmentah",
            data: {
            ...
            success: function(res) {
               if (res.status == 200) {
                  ...
                  $("#modal-form div.modal-header h4.modal-title").html("Ubah Data Bahan Mentah");
                  $("#modal-form form#form-data #mentah_id").val(res.data.id);
                  $("#modal-form form#form-data #mentah_nama").val(res.data.mentah_nama);
                  $("#modal-form form#form-data #mentah_satuan").val(res.data.mentah_satuan);
                  $("#modal-form form#form-data #mentah_harga").val(res.data.mentah_harga);
                  $("#modal-form form#form-data #mentah_desc").html(res.data.mentah_desc);
               } else {
                  swal({
                     title: "Error",
                     text: res.pesan,
      ...
      .on("click", "table#tb-data button.item_hapus", function(e) {
         ...
         swal({
            ...
            if (result) {
               $.ajax({
                  type: "POST",
                  url: BASE_URL + "/bahanmentah/deleteBahanmentah",
                  data: {
                     id: id
                  },
                  dataType: "json",
   ...
   $(document).off("click", "button.item_tambah")
      .on("click", "button.item_tambah", function(e) {
         ...
         $("#modal-form div.modal-header h4.modal-title").html("Tambah Data Bahan Mentah");
         $("#modal-form form#form-data input").val(null);
         $("#modal-form form#form-data #mentah_desc").html(null);
      });
   ...
   $(document).off("hidden.bs.modal", "#modal-form")
      .on("hidden.bs.modal", "#modal-form", function(e) {
         ...
         $("form#form-data #mentah_desc").removeClass("is-invalid");
         $("form#form-data #mentah_desc").removeClass("is-valid");
   ...
   function simpan() {
      ...
      $.ajax({
         type: "POST",
         url: BASE_URL + "/bahanmentah/saveBahanmentah",
         data: datas,
         dataType: "json",
         cache: false,
         contentType: false,
