...
<head>
   ...
   <title>Free Bootstrap Admin Template — Stisla</title>
...
<body class="">
   ...
   <nav class="navbar navbar-reverse navbar-expand-lg">
      <div class="container">
         <a class="navbar-brand smooth" href="<?= base_url(); ?>/">Stisla</a>
         ...
         <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto ml-lg-3 align-items-lg-center">
               <li class="nav-item dropdown"><a href="<?= base_url(); ?>/#" data-toggle="dropdown" class="nav-link dropdown-toggle">Developers</a>
                  <ul class="dropdown-menu">
                     <li class="dropdown-title">Getting Started</li>
                     <li><a href="<?= base_url(); ?>/getting-started" class="dropdown-item">Getting Started</a></li>
                     <li><a href="<?= base_url(); ?>/docs" class="dropdown-item">Documentation</a></li>
                     ...
                     <li><a href="http://demo.getstisla.com/assets/modules-calendar.html" class="dropdown-item">Third-party Libraries</a></li>
               ...
               <li class="nav-item"><a href="<?= base_url(); ?>/support" class="nav-link">Support</a></li>
               <li class="nav-item"><a href="<?= base_url(); ?>/page/contact" class="nav-link">Contact</a></li>
               <li class="nav-item d-lg-none d-md-block"><a href="<?= base_url(); ?>/download" class="nav-link smooth" target="_blank">Download</a></li>
            </ul>
            <ul class="navbar-nav ml-auto align-items-lg-center d-none d-lg-block">
               <li class="ml-lg-3 nav-item">
                  <a href="<?= base_url(); ?>/download" class="btn btn-round smooth btn-icon icon-left" target="_blank">
      ...
      <div class="hero">
         <div class="container">
            <div class="text text-center text-lg-left">
               <a href="<?= base_url(); ?>/blog/open-source" class="headline">
               ...
               <div class="cta">
                  <a class="btn btn-lg btn-warning btn-icon icon-right" href="<?= base_url(); ?>/getting-started">Get Started <i class="fas fa-chevron-right"></i></a> &nbsp;
            ...
            <div class="image d-none d-lg-block">
               <img src="<?= base_url(); ?>/assets/img/yufifood.png" alt="img">
            </div>
         </div>
      </div>
   </div>
      ...
      <div class="container">
         <div class="row">
            <div class="col-lg-5 d-none d-lg-block">
               <img src="./Free Bootstrap Admin Template — Stisla_files/undraw_processing_qj6a.svg" alt="user flow" class="img-fluid">
            </div>
            <div class="col-lg-7 pl-lg-5 col-md-12">
               ...
               <p class="lead">Your idea has other things that need to be prioritized, don't waste your time only on the dashboard design. Stisla will speed up your project to design a clean dashboard interface.</p>
               <div class="mt-4">
                  <a href="<?= base_url(); ?>/" class="link-icon">
   ...
   <section id="dashboard" class="section-skew">
      <div class="container">
         ...
         <div class="row">
            <div class="col-md-6">
               <div class="pre-block">
                  <pre class="language-js code-toolbar" data-name="modal.js"><code class=" language-js"><span class="token function">$</span><span class="token punctuation">(</span><span class="token string">"#my-button"</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">fireModal</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
  body<span class="token punctuation">:</span> <span class="token string">'&lt;p&gt;Your content goes here.&lt;/p&gt;'</span><span class="token punctuation">,</span>
  created<span class="token punctuation">:</span> <span class="token keyword">function</span><span class="token punctuation">(</span>modal<span class="token punctuation">)</span> <span class="token punctuation">{</span>
      console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span><span class="token string">'Modal has been created'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
  buttons<span class="token punctuation">:</span> <span class="token punctuation">[</span>
    <span class="token punctuation">{</span>
      text<span class="token punctuation">:</span> <span class="token string">'Action'</span><span class="token punctuation">,</span>
      <span class="token keyword">class</span><span class="token punctuation">:</span> <span class="token string">'btn btn-primary btn-shadow'</span><span class="token punctuation">,</span>
      handler<span class="token punctuation">:</span> <span class="token keyword">function</span><span class="token punctuation">(</span>modal<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code><div class="toolbar"><div class="toolbar-item"><span>Js</span></div><div class="toolbar-item"><a>Copy</a></div></div></pre>
               </div>
            </div>
            <div class="col-md-6">
               <div class="browser-container">
                  ...
                  <div class="browser-content d-flex align-items-center justify-content-center flex-column">
                     ...
                     <a href="<?= base_url(); ?>/#" class="btn btn-primary trigger--fire-modal-1" id="my-button">Click Me</a>
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class="container">
         <div class="row">
            <div class="col-lg-7 pr-lg-5 pr-0">
               ...
               <p class="lead">Designing a dashboard can be a nightmare if it's not based on a concept, your time will run out just to think about what components will be created. Stisla has many components, so you just need to adjust it. Save your time, go to bed early.</p>
               <div class="mt-4">
                  <a href="<?= base_url(); ?>/" class="link-icon">
            ...
            <div class="col-lg-5 d-none d-lg-block">
               <div class="abs-images">
                  <img src="./Free Bootstrap Admin Template — Stisla_files/countries.png" alt="user flow" class="img-fluid rounded dark-shadow">
                  <img src="./Free Bootstrap Admin Template — Stisla_files/ticket.png" alt="user flow" class="img-fluid rounded dark-shadow">
                  <img src="./Free Bootstrap Admin Template — Stisla_files/user.png" alt="user flow" class="img-fluid rounded dark-shadow">
               </div>
            </div>
         </div>
      </div>
         ...
         <div class="row">
            <div class="col-lg-8 d-none d-lg-block pr-lg-5 pr-sm-0">
               <div class="d-flex align-items-center h-100 justify-content-center abs-images-2">
                  <img src="./Free Bootstrap Admin Template — Stisla_files/stisla-preview-mid.png" alt="image" class="img-fluid rounded dark-shadow">
                  <img src="./Free Bootstrap Admin Template — Stisla_files/pricing.png" alt="image" class="img-fluid rounded dark-shadow">
                  <img src="./Free Bootstrap Admin Template — Stisla_files/stats.png" alt="image" class="img-fluid rounded dark-shadow">
               </div>
            </div>
            <div class="col-lg-4 col-md-12">
               ...
               <ul class="list-icons">
                  ...
                  <li>
                     ...
                     <span>Get all the Stisla components and 30+ integrated assets/modules.</span>
                  </li>
                  <li>
                     <span class="card-icon bg-primary text-white">
      ...
      <div class="container">
         <div class="row align-items-center">
            ...
            <div class="col-md-5 text-right">
               <a href="<?= base_url(); ?>/download" class="btn btn-primary btn-lg">Download Stisla Now</a>
            </div>
         </div>
      </div>
   </section>
                  ...
                  <div class="card-body d-flex p-45">
                     ...
                     <div>
                        ...
                        <div class="mt-4 text-right">
                           <a href="<?= base_url(); ?>/docs" class="link-icon">Documentation <i class="fas fa-chevron-right"></i></a>
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <div class="card long-shadow">
                  <div class="card-body p-45 d-flex">
                     ...
                     <div>
                        ...
                        <div class="mt-4 text-right">
                           <a href="<?= base_url(); ?>/support" class="link-icon">Support <i class="fas fa-chevron-right"></i></a>
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <div class="row">
                  <div class="col-md-4">
                     ...
                     <ul>
                        ...
                        <li><a href="http://demo.getstisla.com/assets/modules-calendar.html">Third-party Libraries</a></li>
                  ...
                  <div class="col-md-4">
                     <h4>Developers</h4>
                     <ul>
                        <li><a href="<?= base_url(); ?>/getting-started">Get Started</a></li>
                        <li><a href="<?= base_url(); ?>/download" target="_blank">Download</a></li>
   ...
   <script type="text/javascript">
      var Ziggy = {
         namedRoutes: {
            ...
            "orders.email": {
               "uri": "dashboard\/orders\/{id}\/email\/{email}",
               "methods": ["GET", "HEAD"],
               "domain": null
            },
            "orders.paid": {
               "uri": "dashboard\/orders\/{id}\/paid",
               "methods": ["GET", "HEAD"],
               "domain": null
            },
            "confirmPayments.index": {
               "uri": "dashboard\/confirmPayments",
               "methods": ["GET", "HEAD"],
               "domain": null
            },
            "confirmPayments.create": {
               "uri": "dashboard\/confirmPayments\/create",
               "methods": ["GET", "HEAD"],
               "domain": null
            },
            "confirmPayments.store": {
               "uri": "dashboard\/confirmPayments",
               "methods": ["POST"],
               "domain": null
            },
            "confirmPayments.show": {
               "uri": "dashboard\/confirmPayments\/{confirmPayment}",
               "methods": ["GET", "HEAD"],
               "domain": null
            },
            "confirmPayments.edit": {
               "uri": "dashboard\/confirmPayments\/{confirmPayment}\/edit",
               "methods": ["GET", "HEAD"],
               "domain": null
            },
            "confirmPayments.update": {
               "uri": "dashboard\/confirmPayments\/{confirmPayment}",
               "methods": ["PUT", "PATCH"],
               "domain": null
            },
            "confirmPayments.destroy": {
               "uri": "dashboard\/confirmPayments\/{confirmPayment}",
               "methods": ["DELETE"],
               "domain": null
            },
            "confirmPayments.accept": {
               "uri": "dashboard\/confirmPayments\/{id}\/{order_id}\/accept",
               "methods": ["GET", "HEAD"],
               "domain": null
            },
            "posts.index": {
            ...
            "supports.show": {
               "uri": "dashboard\/supports\/{support}",
               "methods": ["GET", "HEAD"],
               "domain": null
            },
            "supports.edit": {
               "uri": "dashboard\/supports\/{support}\/edit",
               "methods": ["GET", "HEAD"],
               "domain": null
            },
            "supports.update": {
